...
\begin{document}
\maketitle
\let\thefootnote\relax\footnotetext{DOI: \url{https://doi.org/10.5281/zenodo.20735677}}
...
addition --- spanning 10 abstraction levels, 246 theorems, and 41,347 lines
of proof, all verified by a 622-line sequent calculus kernel.
...
\begin{enumerate}
  ...
  \item \textbf{Kernel-verified.} A minimal proof kernel checks every proof
    ...
    small enough (622 lines of C) to be audited by a human.
\end{enumerate}
...
\begin{itemize}
  \item \textbf{Humans cannot write these proofs.} The sheer volume of
    mechanical proof steps exceeds what a person can sustain. Writing 41,347
  ...
  \item \textbf{Humans cannot verify these proofs.} Without a mechanical
    checker, there is no way to confirm that 41,347 lines of proof are
...
The proof kernel is a 622-line C module (\texttt{kernel.c} + \texttt{kernel.h}).
...
defined as a semicolon-terminated transition table string:
...
Proof kernel (C) & 622 lines \\
Total theorems & 246 \\
Total proof code & 41,347 lines \\
...
The error was caught mechanically, in minutes, by a 622-line kernel during an
