...
\begin{document}
\maketitle
\let\thefootnote\relax\footnotetext{DOI: \url{https://doi.org/10.5281/zenodo.20746796} \quad Source: \url{https://github.com/yuchenkan/min}}
...
proof construction --- for example, that addition produces values no smaller
than its inputs --- it dropped to the arithmetic layer, proved the needed
