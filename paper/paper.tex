...
When the LLM encountered missing lemmas during TM proof construction ---
for example, that addition values are unique, or that addition produces
values no smaller than its inputs --- it dropped to the arithmetic layer,
proved the needed theorems, and resumed the TM proof. Cross-abstraction
reasoning occurred not only in the final proof but in the development
process itself.
...
even in dedicated set theory formalizations --- all 199 theorems use only
Extensionality, Empty Set, Pairing, Union, Power Set, Separation, and
Infinity.
