...
def tmstep_to_reaches():
    ...
    from vocab.tm import TMStep, TMReaches
    from vocab.functions import Function as FuncDef, Apply
    from tactics import apply_thm, mp, ax, fl, eir, eel, cut, wl, wr
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
        or_intro_right, eq_reflexive, eq_symmetric, iff_mp_rev, unique_empty)
...
def phase2():
    ...
    from tactics import apply_thm, mp, ax, fl, eir, eel, cut, wl, wr, weaken_to
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
        or_intro_left, or_intro_right, eq_reflexive, eq_symmetric, eq_transitive)
    from theorems.sets import ordpair_exists, ordpair_eq_transfer, ordpair_set_transfer, tuple_injection
    from theorems.omega import func_unique_thm, omega_contains_empty
    from theorems.tm import (Phase2P, config_decompose, apply_func_transfer,
        ...
        tape_update_eq_args, tmstep_to_reaches as _ttr_fn)
    from theorems.recursion import eq_apply_transfer
    ...
    from theorems.tm import tmstep_to_reaches as _ttr_fn
    from theorems.omega import omega_contains_empty
...
def phase4():
    ...
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
        or_intro_left, or_intro_right, or_elim,
        eq_reflexive, eq_symmetric, eq_transitive, iff_sym, iff_chain, iff_mp_rev)
    from theorems.sets import (ordpair_exists, ordpair_eq_transfer, ordpair_set_transfer,
        tuple_injection, succ_injection, eq_transfer, unique_successor)
    from theorems.omega import (func_unique_thm, omega_succ_closed,
        omega_contains_empty, omega_exists)
    from theorems.tm import (Phase4P, config_decompose, apply_func_transfer,
        config_eq_transfer, tape_update_eq, tmstep_to_reaches, zero_neq_one,
        func_eq_transfer)
...
def phase3_base():
    ...
    from vocab.omega import Omega, Num
    from vocab.sets import Empty, Singleton
    from vocab.tm import TMConfig, TMTransition, TMStep
    from vocab.functions import Function as FuncDef, Apply
    from vocab.recursion import Plus as PlusDef
    from tactics import apply_thm, mp, ax, eir, eel, cut, wl
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
...
def phase3_step_case():
    ...
    from tactics import apply_thm, mp, ax, eir, eel, cut, wl
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
        or_intro_right, eq_reflexive, eq_symmetric, iff_mp_rev)
...
def phase3():
    ...
    from theorems.sets import (ordpair_exists as _oe_fn, ordpair_unique as _ou_fn,
        omega_transitive_set as ots_fn, eq_transfer, singleton_exists)
    from vocab.sets import TransitiveSet
    from tactics import apply_thm, mp, ax, fl, eir, eel, cut, wl, wr, weaken_to
    from theorems.logic import (and_intro, and_elim_left, and_elim_right,
        or_intro_left, or_intro_right, or_elim,
...
def tmreaches_compose():
    ...
    from theorems.arithmetic import (plus_zero_exists, plus_succ_right,
        plus_val_in_omega, plus_val_unique)
    from theorems.recursion import eq_apply_transfer, eq_apply_val_transfer
    from theorems.tm import (TMReachesCompose, phase1_step_extend_trace,
        tape_update_exists, tape_update_at, tape_update_other, tape_update_function)
